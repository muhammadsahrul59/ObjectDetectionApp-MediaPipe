...
class ObjectDetectorHelper(
    ...
    var currentModel: Int = MODEL_OBJECTDETECTION,
    ...
    fun setupObjectDetector() {
        ...
        val modelName = when (currentModel) {
            MODEL_OBJECTDETECTION -> "objectdetection.tflite"
            MODEL_EFFICIENTDETV2 -> "animal.tflite"
            else -> "objectdetection.tflite"
        }
    ...
    companion object {
        ...
        const val MODEL_OBJECTDETECTION = 0
